...
export const asyncRoutes = [
  {
    path: '/article',
    component: Layout,
    meta: { title: '文章管理', icon: 'form', roles: ['article'] },
    children: [
      {
        path: 'index',
        name: 'article',
        ...
        meta: { title: '新增文章', icon: 'form', roles: ['articleAdd'] }
      }, {
        path: 'articleColumn',
        name: 'articleColumn',
        component: () => import('@/views/article/articleColumn'),
        meta: { title: '栏目管理', icon: 'tree', roles: ['articleAdd'] }
      }
    ]
  },
  {
    path: '/sys',
    component: Layout,
    meta: { title: '系统管理', icon: 'tree', roles: ['admin'] },
    children: [
      {
        path: 'user',
        name: 'sysUser',
